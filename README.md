...
Clipping is only applied to the detector geometry, not to events or overlaps that have been identified. After updating any of the clipping box parameters or checking/unchecking the checkboxes, clicking **Apply Changes** will update the view. Clicking **Clear** restores the original geometry and resets the clipping parameters.
